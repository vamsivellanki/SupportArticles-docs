---
title: Troubleshoot the VMExtensionError_K8SAPIServerDNSLookupFail error 
...
This article discusses how to identify and resolve the `VMExtensionError_K8SAPIServerDNSLookupFail` error (also known as error code ERR_K8S_API_SERVER_DNS_LOOKUP_FAIL) that occurs when you try to start or create and deploy a Microsoft Azure Kubernetes Service (AKS) cluster.
